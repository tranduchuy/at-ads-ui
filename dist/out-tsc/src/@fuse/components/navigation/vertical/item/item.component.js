...
let FuseNavVerticalItemComponent = class FuseNavVerticalItemComponent {
     ...
     */
    constructor(_changeDetectorRef, _fuseNavigationService, _sessionService) {
    ...
    changeActiveAccount() {
        this._sessionService.setActiveAccountId(this.item.id.toString()); // save
        //this._sessionService.setAdwordId(this.item.id.toString());
