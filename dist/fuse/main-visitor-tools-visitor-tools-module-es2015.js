 ...
 * @type {?}
 */
const CDK_DROP_LIST = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('CDK_DROP_LIST');
/**
 * Injection token that is used to provide a CdkDropList instance to CdkDrag.
 * Used for avoiding circular imports.
 ...
 * @type {?}
 */
const CDK_DRAG_PARENT = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('CDK_DRAG_PARENT');
 ...
 * @type {?}
 */
const CDK_DRAG_CONFIG = new _angular_core__WEBPACK_IMPORTED_MODULE_3__["InjectionToken"]('CDK_DRAG_CONFIG', {
    providedIn: 'root',
...
class CdkDrag {
    ...
    constructor(element, dropContainer, _document, _ngZone, _viewContainerRef, config, _dir, dragDrop, _changeDetectorRef) {
        ...
        (observer) => {
            /** @type {?} */
            const subscription = this._dragRef.moved.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["map"])((/**
             * @param {?} movedEvent
             * @return {?}
             */
            movedEvent => ({
    ...
    ngAfterViewInit() {
        ...
        () => {
            ...
            this._handles.changes.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["startWith"])(this._handles), 
            ...
            })), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_7__["takeUntil"])(this._destroyed)).subscribe((/**
...
let FakeCustomerComponent = class FakeCustomerComponent extends app_shared_components_base_page_base_component__WEBPACK_IMPORTED_MODULE_11__["PageBaseComponent"] {
    constructor(_fuseProgressBarService, _fuseSplashScreenService, _websiteManagementService, _dialogService, _sessionService, _visitorToolsService) {
        ...
        this.websiteCtrl = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]();
        /** control for the MatSelect filter keyword */
        this.websiteFilterCtrl = new _angular_forms__WEBPACK_IMPORTED_MODULE_8__["FormControl"]();
        /** list of websites filterd by search keyword */
        this.filteredWebsites = new rxjs__WEBPACK_IMPORTED_MODULE_9__["ReplaySubject"](1);
        this._onDestroy = new rxjs__WEBPACK_IMPORTED_MODULE_9__["Subject"]();
        this.enableDisplayToggle = {
        ...
        this.isAvatarStorageShown = false;
        this.minAutoDisplayTime = 10; // seconds
        this.maxAutoDisplayTime = 90; // seconds
        //===================
        this.fakeDataFields = [
            {
                name: '#fake_name',
    ...
    removeSelectedFakeDataField(index, option) {
        //Title
        if (option === 1) {
    ...
    onSelectFakeDataField(field, option) {
    ...
    clearAllSelectedFakeData(option) {
        //Title
        if (option === 1) {
            // this.selectedTitleFakeDataFields = [];
    ...
    generateFakeCustomerConfig(opt) {
        if (opt === 1)
    ...
    onSelectRunningDeviceCheckBox(e, value) {
        const checkedDevice = lodash__WEBPACK_IMPORTED_MODULE_13__["find"](this.displayConfig.runningDevices, d => d.value === value);
        ...
        const sub = this._websiteManagementService.getWebsites(accountId)
            ...
            if (this.websites.length > 0) {
                ...
                this.websiteFilterCtrl.valueChanges
                    .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_12__["takeUntil"])(this._onDestroy))
                    .subscribe(() => {
                    this.filterWebsites();
                });
